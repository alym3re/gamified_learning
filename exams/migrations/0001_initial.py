    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grading_period', models.CharField(choices=[('prelim', 'Prelim'), ('midterm', 'Midterm'), ('prefinal', 'Prefinal'), ('final', 'Final')], default='prelim', max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('multiple_choice', 'Multiple Choice'), ('true_false', 'True/False'), ('identification', 'Identification')], default='multiple_choice', max_length=20)),
